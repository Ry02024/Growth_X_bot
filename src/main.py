...
research_topic.save_knowledge_as_json(research_topic_path, knowledge_entry)
# research_topic.save_research_result_to_json(research_result, "../data/research_results.json")
# 調査結果の保存を確認
print("調査結果が保存されました。")
# 投稿モジュールをテスト
latest_tweet = x_poster.get_latest_tweet(research_topic_path)
